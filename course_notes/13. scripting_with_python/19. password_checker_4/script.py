...
# file path for this is:
# michaeldugan@Michaels-MacBook-Pro ztm_python_course_notes % cd course_notes/13.\ scripting_with_python/19.\ password_checker_4

# add a backslash before symbols '\'
